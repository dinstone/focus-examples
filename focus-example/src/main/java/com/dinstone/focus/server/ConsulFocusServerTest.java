...
import com.dinstone.focus.server.consul.ConsulResolverOptions;
...
public class ConsulFocusServerTest {
	...
	public static void main(String[] args) {
		ConsulResolverOptions resolverOptions = new ConsulResolverOptions().setAgentHost("192.168.1.120")
				.setAgentPort(8500);
		ServerOptions serverOptions = new ServerOptions("com.rpc.demo.server").listen("-", 3333)
				.setAcceptOptions(new PhotonAcceptOptions()).setResolverOptions(resolverOptions);
